var DNNBlogAngular = DNNBlogAngular || {};

DNNBlogAngular.itemViewModel = function (moduleId, resx) {
    var service = {
        path: "DNNBlogAngular",
    ...
    var loadUsers = function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
            var result = data[i];
            var user = new DNNBlogAngular.user(result.id, result.name);
...
DNNBlogAngular.user = function (id, name) {
    this.id = id;
    this.name = name;
}